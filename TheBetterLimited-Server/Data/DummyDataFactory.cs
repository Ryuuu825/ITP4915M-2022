        ...
        public static Supplier_Goods_Stock[] CreateSupplier_Goods_Stock()
        {
            return new Supplier_Goods_Stock[]
            {
                new Supplier_Goods_Stock
                {
                    ...
                    Quantity = ran.Next(5000, 10000),
                    MaxLimit = ran.Next(10000, 15000),
                    MinLimit = ran.Next(0 , 5000),
                    ReorderLevel = ran.Next(5500 , 8000),
                },
                new Supplier_Goods_Stock
                {
                    Id = "100000002",
                ...
                new Supplier_Goods_Stock
                {
                    ...
                    _locationId = "004",
                    _supplierGoodsId = "100000005",
                    Quantity = ran.Next(0, 10000),
                    MaxLimit = ran.Next(0, 10000),
                    MinLimit = ran.Next(0, 10000),
                    ReorderLevel = ran.Next(0, 10000),
                },
                new Supplier_Goods_Stock
                {
                    Id = "100000012",
