...
namespace TheBetterLimited.Controller
{
    ...
    {
        public SessionController(string ControllerName) : base(ControllerName)
        {
            this.ControllerName = ControllerName;
        }

        public RestResponse GetAll(int month, int day, string deptId, string limit = "0", string offset = "0", string lang = "en")
        {
            var request = new RestRequest("/api/" + ControllerName, Method.Get)
                        ...
                        .AddQueryParameter("departmentId", deptId)
